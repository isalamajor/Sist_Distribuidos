...
int main() {
  ...
  printf("Valor1 debería ser Hola: %s\n", valor1);
  printf("N_valor2 debería ser 3: %d\n", N_valor2);
  printf("V_valor2 debería ser 1.0, 2.0, 3.0\n");
  ...
  printf("Valor1 debería ser Adios: %s\n", valor1);
  printf("N_valor2 debería ser 3: %d\n", N_valor2);
  printf("V_valor2 debería ser 4.0, 5.0, 6.0\n");
  for (int i = 0; i < N_valor2; i++) {
    printf("  V_valor2[%d]: %f\n", i, V_valor2[i]);
  }
  printf("Resultado de Exist debería ser 1: %d\n", exist(1000));
  ...
  printf("Resultado de Exist debería ser 0: %d\n", exist(1000));
